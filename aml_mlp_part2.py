#meta for myFiftyoneComputerVision 6/10/2025 AML MLP 1 POC AI Doc Vision. Split MLP Vis51 -> Part2 (off GPU code), dataset $config
...
# $next: Part 2 (off GPU code) - add TSNE (and UMAP) reductions, no fields yet
